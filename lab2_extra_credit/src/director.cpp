...
Director::Director(const string& script_file, unsigned int min_player_number, bool override_flag)
{
    ...
    unsigned int recruit_num = override_flag? min_player_number : max(static_cast<unsigned int>(max_characters_in_two_scene), min_player_number);
    recruit(recruit_num);
