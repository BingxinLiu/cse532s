...
public:
    ...
    virtual int handle_timeout (const ACE_Time_Value& ace_time_value, const void* _ )
    {
        ...
        // {
        //     transform(str.begin(), str.end(), str.begin(), [this](char c){
        //         this->client_interceptor(c);
        //         return c;
        //     });
        // }
        ...
        for (size_t i = 1; i < argc; ++i)
        {
            ...
            if ( this->client_interceptor != nullptr )
            {
                transform(send_str.begin(), send_str.end(), send_str.begin(),[this](char c) -> char {
                    this->client_interceptor->operator()(c);
                    cout << c << " ";
                    return c;
                });
                cout << endl;
...
main(int argc, char* argv[])
{
    ...
    pass_through_interceptor intercptr;
